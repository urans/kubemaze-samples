...
import (
	...
	uransiov1alpha1 "github.com/urans/kubemaze-samples/memcached-operator/api/v1alpha1"
)

const memcachedFinalizer = "urans.io.urans.io/finalizer"
...
//+kubebuilder:rbac:groups=urans.io.urans.io,resources=memcacheds,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=urans.io.urans.io,resources=memcacheds/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=urans.io.urans.io,resources=memcacheds/finalizers,verbs=update
...
func (r *MemcachedReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	memcached := &uransiov1alpha1.Memcached{}
...
func (r *MemcachedReconciler) doFinalizerOperationsForMemcached(cr *uransiov1alpha1.Memcached) {
...
func (r *MemcachedReconciler) deploymentForMemcached(
	memcached *uransiov1alpha1.Memcached) (*appsv1.Deployment, error) {
